...
- [x] 8. 创建包含 L1-L5 文章的 About 页面



  - [x] 8.1 创建 About 页面路由和内容
...
- [x] 9. 创建包含 GEO 文章的 Blog 页面


  - [x] 9.1 创建 Blog 页面路由和内容
...
- [x] 11. 实现详情页路由的 AI Bot 检测



  - [x] 11.1 增强 ai-detector 中的 User-Agent 检测

    - 更新 `lib/ai-detector.ts`，添加全面的 Bot 模式
    - 添加函数判断请求是否应重定向
    - _需求: 6.3_

  - [x] 11.2 在 Agent 详情页实现重定向逻辑
