...
- [ ] 2. GitHub 爬虫实现
  ...
  - [x] 2.3 创建 GitHub 爬虫源 (`crawler/sources/github.ts`)
  ...
  - [x] 2.6 更新 enricher 支持 GitHub 数据源
...
- [x] 3. Checkpoint - 确保 GitHub 爬虫测试通过
...
- [x] 4. 首页 AI Bot 统计展示
  ...
  - [x] 4.1 创建 Bot 统计数据获取函数 (`lib/bot-stats.ts`)
  ...
  - [x] 4.4 创建首页 Bot 统计组件 (`components/ai-bot-homepage-stats.tsx`)

    - 展示各 Bot 访问次数和趋势
    - 实现骨架屏加载状态
    - _Requirements: 2.1, 2.2, 2.4_
  - [x] 4.5 集成 Bot 统计组件到首页
...
- [x] 6. IndexNow 主动推送服务
  ...
  - [x] 6.1 创建 IndexNow 服务 (`lib/indexnow.ts`)
  ...
  - [x] 6.4 创建 IndexNow key 文件

    - 在 `public/` 目录创建 key 验证文件
    - 更新 robots.txt 添加 key 位置
    - _Requirements: 4.1_

  - [x] 6.5 集成 IndexNow 到 Agent 发布流程
...
- [x] 7. Checkpoint - 确保 IndexNow 功能测试通过
